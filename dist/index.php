...
<html lang="ja">
	...
	<head>
		...
		<!-- favicon -->
		<link rel="shortcut icon" href="./image/profile.jpg" />
		...
		<!-- swiper css -->
		<link rel="stylesheet" href="./vender/swiper/css/swiper-bundle.min.css" />

		<!-- tailwind css -->
		<link rel="stylesheet" href="./vender/tailwind/css/tailwind.css" />
	...
	<body class="archive">
			...
			<div class="l-contents__main">
				<header class="p-header">
					<div class="p-header__inner">
						<h1 class="p-header__inner--ttl"><a href="#">Hamburger</a></h1>

						<form id="searchform" class="p-search">
							<input id="" class="p-search__word fas fa-search" placeholder="&#xf002;" />
							<input id="searchsubmit" class="p-search__btn" type="submit" value="検索" />
						</form>
					</div>
				...
				<div class="p-mv">
					...
					<h2 class="p-mv__ttl">Menu:<span>チーズバーガー</span></h2>
				</div>

				<article class="p-front-page-main">
					<div class="p-front-page-main__inner">
						<section class="p-front-page-sec">
							<h2 class="c-ttl_under"><a href="#">Take Out</a></h2>

							<div class="p-front-page-sec__wrapper">
								<div class="p-front-page-sec__contents">
									<h3>小見出しが入ります</h3>
		...
		<script src="./vender/scrollreveal/js/scrollreveal.min.js"></script>
		<script src="./vender/swiper/js/swiper-bundle.min.js"></script>
